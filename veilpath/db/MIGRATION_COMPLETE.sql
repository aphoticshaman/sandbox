-- ═══════════════════════════════════════════════════════════
-- LunatIQ Tarot - COMPLETE Progression Migration for Neon
-- ═══════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════
-- USERS TABLE (adds is_premium column if missing)
-- ═══════════════════════════════════════════════════════════

-- Add is_premium column to existing users table (idempotent)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- ═══════════════════════════════════════════════════════════
-- Create user_progression row for all existing users
...
-- Uncomment these to verify success:
